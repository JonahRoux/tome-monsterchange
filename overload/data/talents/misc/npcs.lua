...
newTalent{
	...
	mode = "passive",
	points = 5,
	Coeff = function(self, t) return self:combatTalentScale(t, 2, 3) end,
	callbackOnActBase = function(self,t)
		if self.buffid then self:removeTemporaryValue("combat_physspeed", self.buffid) end
		local bonus = (1 - self.life / self.max_life)*t.Coeff(self, t)
		self.buffid = self:addTemporaryValue("combat_physspeed", bonus)
	end,
