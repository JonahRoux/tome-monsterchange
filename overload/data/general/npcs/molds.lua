...
newEntity{
	...
	on_die = function(self, src)
		game.level.map:addEffect(self,
			self.x, self.y, self.explosion_radius or 0,
			self.explosion_type or engine.DamageType.NATURE, self.explosion_strength or 0,
			2,
			5, nil,
			engine.MapEffect.new{color_br=150, color_bg=255, color_bb=150, effect_shader="shader_images/poison_effect.png"}
		)
		game.logSeen(self, "%s exudes a cloud of spores as it dies.", self.name:capitalize())
	end,
}

newEntity{ base = "BASE_NPC_MOLD",
	name = "grey mold", color=colors.SLATE,
	explosion_type = engine.DamageType.NATURE_SLOW,
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	explosion_type = engine.DamageType.BLIGHT,
	explosion_strength = 10,
	explosion_radius = 5,
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	explosion_type = engine.DamageType.BLINDNESS,
	explosion_strength = 10,
	explosion_radius = 5,
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	explosion_type = engine.DamageType.INSIDIOUS_POISON,
	explosion_strength = 10,
	explosion_radius = 5,
